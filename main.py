...
def main():
    ...
    for item in stocklist:
        ...
        monthly_content = yf().monthly_status(stock_content)
        if (yf().upper_trend(daily_content, "5MA") and # 只要是往上的就可以
            ...
            yf().upper_trend(monthly_content, "5MA") and 
            yf().upper_trend(monthly_content, "10MA") and
            yf().high_trend(daily_content) and #5ma要比10ma高且不能高超過1.08
            yf().high_trend(monthly_content) 
